...
var magnetic=function(){function e(e,t={}){if("string"==typeof e)this.elements=document.querySelectorAll(e);else if(Array.isArray(e))this.elements=e.filter(e=>e instanceof Element);else if(e instanceof NodeList||e instanceof Element)this.elements=e;else{console.warn("Invalid selector or elements provided to Magnetic constructor");return}Array.isArray(this.elements)||this.elements instanceof NodeList||(this.elements=[this.elements]),this.options={y:.15,x:.15,s:2,rs:1.5},Array.from(this.elements).forEach(e=>{let i=e.dataset.magnetic?JSON.parse(e.dataset.magnetic):{},s={...this.options,...t,...i};e.dataset.magneticInit||(e.dataset.magneticInit="true",this.bind(e,s))})}return e.prototype.bind=function(e,t){e.addEventListener("mouseenter",()=>{let t=e.getBoundingClientRect();this.y=t.top,this.x=t.left,this.width=t.width,this.height=t.height}),e.addEventListener("mousemove",i=>{let s=(i.clientY-this.y-this.height/2)*t.y,n=(i.clientX-this.x-this.width/2)*t.x;this.move(e,n,s,t.s)}),e.addEventListener("mouseleave",()=>{this.move(e,0,0,t.rs)})},e.prototype.move=function(e,t,i,s){gsap.to(e,{y:i,x:t,force3D:!0,overwrite:"auto",duration:s,ease:"power3.out"})},{make:function(t,i){new e(t,i)}}}();
